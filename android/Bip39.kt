...
object Bip39 {
    private val wordList = listOf(
        ...
        "advice", "advise", "aerobic", "affair", "afford", "afraid", "again", "age",
        ...
        "assume", "asthma", "astonish", "atom", "attack", "attend", "attitude", "attract",
        "auction", "audit", "august", "aunt", "author", "auto", "autumn", "available",
        "average", "avocado", "avoid", "awake", "aware", "away", "awesome", "awful",
        "awkward", "axis", "baby", "bachelor", "bacon", "badge", "bag", "balance",
        "balcony", "ball", "bamboo", "banana", "banner", "bar", "bare", "bargain",
        ...
        "canvas", "canyon", "capable", "capital", "captain", "caption", "car", "carbon",
        ...
        "chest", "chicken", "chief", "child", "chimney", "china", "chloe", "chocolate",
        ...
        "coffee", "coil", "coin", "collect", "colony", "color", "column", "combine",
        "come", "comfort", "comic", "common", "company", "compass", "compel", "confirm",
        "confront", "confuse", "connect", "consider", "control", "convince", "cook", "cool",
        ...
        "crocodile", "cross", "crouch", "crowd", "crucial", "cruel", "cruise", "crumble",
        ...
        "delay", "deliver", "delivery", "demand", "demise", "denial", "dentist", "deny",
        "depart", "depend", "deposit", "depth", "deputy", "derive", "describe", "desert",
        "design", "desk", "despair", "destroy", "detail", "detect", "device", "devote",
        ...
        "divide", "divine", "dizzy", "doctor", "document", "dog", "doll", "dolphin",
        ...
        "enemy", "energy", "enforce", "engage", "engine", "engross", "enjoy", "enlist",
        ...
        "extend", "extra", "eye", "eyebrow", "fabric", "face", "facet", "facilitate",
        "factor", "faculty", "fade", "faint", "faith", "fall", "false", "fame",
        ...
        "fiscal", "fish", "fit", "fitness", "five", "fix", "flag", "flame",
        ...
        "fork", "fortune", "forum", "forward", "fossil", "foster", "found", "four",
        "fowl", "fraction", "fragile", "frail", "frame", "frequent", "fresh", "friend",
        "fringe", "frog", "front", "frost", "frown", "frozen", "fruit", "fuel",
        "fun", "funny", "furnace", "fury", "future", "gadget", "gain", "galaxy",
        "gallery", "game", "gap", "garage", "garbage", "garden", "garlic", "garment",
        "gas", "gasp", "gate", "gather", "gauge", "gear", "genius", "gentle",
        ...
        "grab", "grace", "grain", "grant", "grape", "grass", "gravity", "gray",
        ...
        "nasal", "nasty", "nation", "nature", "near", "neck", "need", "negative",
        "neglect", "neither", "nephew", "nerve", "nest", "net", "network", "neutral",
        "never", "news", "next", "nice", "night", "noble", "noise", "nominee",
        "noon", "north", "nose", "notable", "note", "nothing", "notice", "novel",
        ...
        "permit", "person", "pet", "phantom", "phase", "phone", "photo", "phrase",
        ...
        "prepare", "present", "preserve", "press", "prevail", "prevent", "price", "pride",
        ...
        "repeat", "replace", "report", "require", "rescue", "resemble", "resist", "resort",
        "resource", "respond", "rest", "result", "retire", "retreat", "return", "reunion",
        ...
        "round", "route", "royal", "rubber", "rude", "rugby", "rule", "run",
        ...
        "squirrel", "stable", "stadium", "staff", "stage", "stair", "stamp", "stand",
        ...
        "thing", "this", "thought", "three", "thrive", "throat", "through", "throw",
        ...
        "wear", "weasel", "weather", "webcam", "wedding", "weekend", "weird", "welcome",
    ...
    fun entropyToMnemonic(entropy: ByteArray): String {
        require(entropy.size == 16) { "Entropy must be 16 bytes for 12 words" }
        val hash = MessageDigest.getInstance("SHA-256").digest(entropy)
        val checksum = hash[0].toInt() and 0xFF shr 4

        val bits = StringBuilder()
        for (b in entropy) {
            bits.append(Integer.toBinaryString((b.toInt() and 0xFF) + 0x100).substring(1))
        }
        bits.append(Integer.toBinaryString(checksum + 0x10).substring(1))
    ...
    fun generateVerificationHash(mnemonic: String): String {
